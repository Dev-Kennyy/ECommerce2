...
function MegaSaleProduct({ title, price, images, id }) {
  ...
  return (
    ...
    >
      ...
      <p className="font-semibold text-neutralDark text-sm mt-2 truncate w-full px-2">
        <SliceTitle title={title} />
      </p>
      <p className="text-left text-primary font-semibold">${price}</p>
      <div className="flex">
...
export default MegaSaleProduct;
